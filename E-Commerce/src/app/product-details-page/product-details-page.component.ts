...
export class ProductDetailsPageComponent {
  ...
  chooosenProductDetails: any;

  ngOnInit() {
    const chooosenProductId = this.activeRoute.snapshot.params['productId'];
    console.log(chooosenProductId);
    this.chooosenProductDetails = this.productsList.find(
      (product: any) => product.id == chooosenProductId
    );
    console.log(this.chooosenProductDetails);
  }
}
